    ...
    <div className="mx-auto max-w-[840px] px-6 pb-16 sm:px-8">
      ...
      <section className="pb-16 pt-16 text-center sm:pb-20 sm:pt-24">
        ...
        <h1 className="mx-auto max-w-[720px] font-serif text-[40px] leading-[0.98] tracking-[-0.045em] text-[var(--text)] sm:text-[58px]">
          ...
          <span className="italic text-[var(--accent)]"> without hiding the source.</span>
        </h1>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <a
            href="#install"
            className="inline-flex items-center gap-2 rounded-[5px] bg-[var(--accent)] px-6 py-2.5 text-sm font-medium text-white hover:bg-[var(--accent-hover)]"
          >
            Get started
            <svg
              width="14"
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-[5px] border border-[color:var(--border-mid)] px-6 py-2.5 text-sm text-[var(--text-secondary)] hover:border-[color:var(--accent)] hover:text-[var(--accent)]"
          >
            View on GitHub
          </a>
        </div>
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-2 rounded-[5px] border border-[color:var(--border)] bg-[var(--bg-elevated)] px-5 py-2.5 text-sm text-[var(--text)] shadow-[var(--shadow-panel)] hover:border-[color:var(--border-mid)] hover:bg-[var(--bg-hover)]"
          >
            <svg
              width="14"
              height="14"
